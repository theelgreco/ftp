<template>
  <section class="section w-full h-full flex flex-col justify-center select-none">
    <div
        class="form md:w-[550px] md:p-16 w-[90%] p-14 mx-auto border-1 border-gray-200 shadow-2xl rounded-2xl overflow-y-auto relative">
      ...
      <div v-else-if="error"
        ...
        <p class="text-gray-400">Couldn't connect to <span class="text-gray-600">{{ form.host }}</span></p>
        <button
